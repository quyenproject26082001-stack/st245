...
import com.cat.catpiano.music.core.extensions.assetFolderHasImage
import com.cat.catpiano.music.core.extensions.expandTouchArea
...
import com.cat.catpiano.music.activity_app.background.BackgroundAdapter
...
class PlayActivity : BaseActivity<ActivityPlayBinding>() {
    ...
    private fun loadCharacters(): List<CharacterModel> {
        ...
        val validFolders = folders.filter { assetFolderHasImage("skin/$it", "avatar") }
        ...
        return validFolders.map { folder ->
            val avatarPath = "skin/$folder/avatar"
            val drawable = openAssetImageDrawable(avatarPath)
            CharacterModel(
    ...
    private fun loadInstruments(): List<InstrumentModel> {
        ...
        val validFolders = folders.filter {
            assetFolderHasImage("instrument/let_play/$it", "nav")
        }
